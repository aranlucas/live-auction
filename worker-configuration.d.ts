/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8bfbb218e21cf645521c4556abe041ab)
// Runtime types generated with workerd@1.20260918.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	READ_RATE_LIMITER: RateLimit;
	COMMAND_RATE_LIMITER: RateLimit;
	ENVIRONMENT: "staging" | "production";
	DEMO_MODE: "enabled" | "disabled";
	AUTH_ISSUER: "https://cloudflare-live-auction.example";
	AUTH_AUDIENCE: "cloudflare-live-auction";
	AUTH_JWKS_URL: "";
	WEB_ORIGINS: "http://localhost:3000,https://gavel-live-web.aranlucas.workers.dev";
	AUTH_JWKS_JSON: "{\"keys\":[{\"kty\":\"EC\",\"x\":\"YPrGDt7Vu1jwOGcQFdVDfbgQjiBe_Ds_8d_nKhVGeX8\",\"y\":\"TpHR0QvFesA5VUnYeLLk2r_sPCJwMoVg3VPxR4I1gb4\",\"crv\":\"P-256\",\"alg\":\"ES256\",\"use\":\"sig\",\"kid\":\"6332bef5-8e80-4ef0-8022-8ed9ebd78377\"}]}";
	AUCTIONS: DurableObjectNamespace<import("./src/index").Auction>;
	AUCTION_FANOUT: DurableObjectNamespace<import("./src/index").AuctionFanout>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Auction" | "AuctionFanout";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEMO_MODE" | "AUTH_ISSUER" | "AUTH_AUDIENCE" | "AUTH_JWKS_URL" | "WEB_ORIGINS" | "AUTH_JWKS_JSON">> {}
}
